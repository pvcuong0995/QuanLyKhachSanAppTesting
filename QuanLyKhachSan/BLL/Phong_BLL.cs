...
namespace QuanLyKhachSan.BLL
{
    public class Phong_BLL
    {
        ...
        {
            string sql = "Select phong.maphong From phong, loaiphong where phong.tenloaiphong = loaiphong.tenloaiphong and loaiphong.tenloaiphong = '" + tenlp + "' and phong.tinhtrang = 'False'";
            return db.getDS(sql);
        }
        ...
        public bool checkTinhTrang(string maphong)
        {
        ...
        {
            string sql = "Select kh.makh,kh.hoten,dp.ngayden,dp.ngaydi from khachhang as kh, datphong as dp, chitietphongdat as ctpd where kh.makh = dp.makh and dp.madp = ctpd.madp and ctpd.maphong = '" + maphong + "'";
            return db.getDS(sql);
        }
    }
}
